...
$DisabledModFolderPrefixes = @(
    ...
    'IPCHigherAISkill_64DCE52D2F882ED2',
    'AllArsenalItemsToPrivate_66C751946DC58A1A',
    # Orphan folders Steam keeps re-downloading even though they're not in serverConfig.json mods[] —
    # added 2026-05-13 after mod_health_check.ps1 caught them returning post-purge:
    'MisfitsSquadBackpacks_652C421FF965A324',
    'RISLaserAttachments_5ABD0CB57F7E9EB1',
    'Zagoria89BMP2_6730D59067916E3D',
    'ModernRussians_65252242719E5A1B',
    '3DRSMODERNRUSSIANSFACTION_666C002F6BB6441C'  # removed iter3, may re-download
)
